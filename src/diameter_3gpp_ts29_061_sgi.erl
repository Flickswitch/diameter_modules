...
-module(diameter_3gpp_ts29_061_sgi).

-compile({parse_transform, diameter_exprecs}).

-compile(nowarn_unused_function).

-export_records([diameter_sgi_AAR,
                 diameter_sgi_AAA,
                 diameter_sgi_RAR,
                 diameter_sgi_RAA,
                 diameter_sgi_STR,
                 ...
                 diameter_sgi_ACR,
                 diameter_sgi_ACA,
                 'diameter_sgi_Proxy-Info',
                 'diameter_sgi_Failed-AVP',
                 'diameter_sgi_Experimental-Result',
                 'diameter_sgi_Vendor-Specific-Application-Id',
                 'diameter_sgi_CHAP-Auth',
                 diameter_sgi_Tunneling,
                 'diameter_sgi_Cost-Information',
                 'diameter_sgi_Unit-Value',
                 'diameter_sgi_Multiple-Services-Credit-Control',
                 'diameter_sgi_Granted-Service-Unit',
                 'diameter_sgi_Requested-Service-Unit',
                 'diameter_sgi_Used-Service-Unit',
                 'diameter_sgi_CC-Money',
                 'diameter_sgi_G-S-U-Pool-Reference',
                 'diameter_sgi_Final-Unit-Indication',
                 'diameter_sgi_Redirect-Server',
                 'diameter_sgi_Service-Parameter-Info',
                 'diameter_sgi_Subscription-Id',
                 'diameter_sgi_User-Equipment-Info']).

-record(diameter_sgi_AAR,
        {'Session-Id',
         'Auth-Application-Id',
         'Origin-Host',
         'Origin-Realm',
...
-record('diameter_sgi_Proxy-Info',
        {'Proxy-Host', 'Proxy-State', 'AVP' = []}).

-record('diameter_sgi_Failed-AVP', {'AVP' = []}).

-record('diameter_sgi_Experimental-Result',
        {'Vendor-Id', 'Experimental-Result-Code'}).

-record('diameter_sgi_Vendor-Specific-Application-Id',
        {'Vendor-Id',
         'Auth-Application-Id' = [],
         'Acct-Application-Id' = []}).

-record('diameter_sgi_CHAP-Auth',
        {'CHAP-Algorithm',
         'CHAP-Ident',
         'CHAP-Response' = [],
         'AVP' = []}).

-record(diameter_sgi_Tunneling,
        {'Tunnel-Type',
         'Tunnel-Medium-Type',
...
-record('diameter_sgi_Cost-Information',
        {'Unit-Value', 'Currency-Code', 'Cost-Unit' = []}).

-record('diameter_sgi_Unit-Value',
        {'Value-Digits', 'Exponent' = []}).

-record('diameter_sgi_Multiple-Services-Credit-Control',
...
-record('diameter_sgi_Granted-Service-Unit',
        {'Tariff-Time-Change' = [],
         'CC-Time' = [],
         'CC-Money' = [],
         'CC-Total-Octets' = [],
...
-record('diameter_sgi_Requested-Service-Unit',
        {'CC-Time' = [],
         'CC-Money' = [],
         'CC-Total-Octets' = [],
         'CC-Input-Octets' = [],
...
-record('diameter_sgi_Used-Service-Unit',
        {'Tariff-Change-Usage' = [],
         'CC-Time' = [],
         'CC-Money' = [],
         'CC-Total-Octets' = [],
...
-record('diameter_sgi_CC-Money',
        {'Unit-Value', 'Currency-Code' = []}).

-record('diameter_sgi_G-S-U-Pool-Reference',
        {'G-S-U-Pool-Identifier',
         'CC-Unit-Type',
         'Unit-Value'}).

-record('diameter_sgi_Final-Unit-Indication',
        {'Final-Unit-Action',
         'Restriction-Filter-Rule' = [],
         'Filter-Id' = [],
         'Redirect-Server' = []}).

-record('diameter_sgi_Redirect-Server',
        {'Redirect-Address-Type', 'Redirect-Server-Address'}).

-record('diameter_sgi_Service-Parameter-Info',
        {'Service-Parameter-Type', 'Service-Parameter-Value'}).

-record('diameter_sgi_Subscription-Id',
        {'Subscription-Id-Type', 'Subscription-Id-Data'}).

-record('diameter_sgi_User-Equipment-Info',
...
rec2msg(diameter_sgi_AAR) -> 'AAR';
rec2msg(diameter_sgi_AAA) -> 'AAA';
rec2msg(diameter_sgi_RAR) -> 'RAR';
rec2msg(diameter_sgi_RAA) -> 'RAA';
rec2msg(diameter_sgi_STR) -> 'STR';
rec2msg(diameter_sgi_STA) -> 'STA';
rec2msg(diameter_sgi_ASR) -> 'ASR';
rec2msg(diameter_sgi_ASA) -> 'ASA';
rec2msg(diameter_sgi_ACR) -> 'ACR';
rec2msg(diameter_sgi_ACA) -> 'ACA';
rec2msg(_) -> erlang:error(badarg).

msg2rec('AAR') -> diameter_sgi_AAR;
msg2rec('AAA') -> diameter_sgi_AAA;
msg2rec('RAR') -> diameter_sgi_RAR;
msg2rec('RAA') -> diameter_sgi_RAA;
msg2rec('STR') -> diameter_sgi_STR;
msg2rec('STA') -> diameter_sgi_STA;
msg2rec('ASR') -> diameter_sgi_ASR;
msg2rec('ASA') -> diameter_sgi_ASA;
msg2rec('ACR') -> diameter_sgi_ACR;
msg2rec('ACA') -> diameter_sgi_ACA;
msg2rec(_) -> erlang:error(badarg).

name2rec('Proxy-Info') -> 'diameter_sgi_Proxy-Info';
name2rec('Failed-AVP') -> 'diameter_sgi_Failed-AVP';
name2rec('Experimental-Result') ->
    'diameter_sgi_Experimental-Result';
name2rec('Vendor-Specific-Application-Id') ->
    'diameter_sgi_Vendor-Specific-Application-Id';
name2rec('CHAP-Auth') -> 'diameter_sgi_CHAP-Auth';
name2rec('Tunneling') -> diameter_sgi_Tunneling;
name2rec('Cost-Information') ->
    'diameter_sgi_Cost-Information';
name2rec('Unit-Value') -> 'diameter_sgi_Unit-Value';
...
name2rec('Used-Service-Unit') ->
    'diameter_sgi_Used-Service-Unit';
name2rec('CC-Money') -> 'diameter_sgi_CC-Money';
...
avp_arity('AAR', 'Framed-Pool') -> {0, 1};
avp_arity('AAR', 'Framed-IPv6-Pool') -> {0, 1};
...
avp_arity('AAR', '3GPP-IMSI') -> {0, 1};
avp_arity('AAR', '3GPP-Charging-Id') -> {0, 1};
avp_arity('AAR', '3GPP-PDP-Type') -> {0, 1};
avp_arity('AAR', '3GPP-CG-Address') -> {0, 1};
avp_arity('AAR', '3GPP-GPRS-Negotiated-QoS-Profile') ->
    {0, 1};
avp_arity('AAR', '3GPP-SGSN-Address') -> {0, 1};
avp_arity('AAR', '3GPP-GGSN-Address') -> {0, 1};
avp_arity('AAR', '3GPP-IMSI-MCC-MNC') -> {0, 1};
avp_arity('AAR', '3GPP-GGSN-MCC-MNC') -> {0, 1};
avp_arity('AAR', '3GPP-NSAPI') -> {0, 1};
avp_arity('AAR', '3GPP-Selection-Mode') -> {0, 1};
avp_arity('AAR', '3GPP-Charging-Characteristics') ->
    {0, 1};
avp_arity('AAR', '3GPP-CG-IPv6-Address') -> {0, 1};
avp_arity('AAR', '3GPP-SGSN-IPv6-Address') -> {0, 1};
avp_arity('AAR', '3GPP-GGSN-IPv6-Address') -> {0, 1};
avp_arity('AAR', '3GPP-SGSN-MCC-MNC') -> {0, 1};
avp_arity('AAR', '3GPP-RAT-Type') -> {0, 1};
avp_arity('AAR', '3GPP-CAMEL-Charging-Info') -> {0, 1};
avp_arity('AAR', '3GPP-Negotiated-DSCP') -> {0, 1};
avp_arity('AAR', '3GPP-Allocate-IP-Type') -> {0, 1};
avp_arity('AAR', '3GPP-User-Location-Info') -> {0, 1};
avp_arity('AAR', 'AVP') -> {0, '*'};
...
avp_arity('AAA', '3GPP-IPv6-DNS-Servers') -> {0, 1};
avp_arity('AAA', 'AVP') -> {0, '*'};
